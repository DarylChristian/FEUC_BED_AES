			    ...
			    <div class="container">
			     <div class=signincontainer>
			      <form class="form-signin" role="form" action="functions/logic_functions.php" method="POST">
			        ...
			        <input name="id_number" type="text" class="form-control" placeholder="Student Number" required autofocus>
			        <input name="last_name" type="password" class="form-control" placeholder="Last Name" required>
